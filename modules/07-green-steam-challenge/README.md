...
A teacher-facing bundle for a small sustainability-themed mini‑app.

## Files in this module

- Module overview: [module-overview.md](./module-overview.md)
- Units:
  - [Unit 7.1 — Sustainability Mini‑App](./unit-7.1-lesson-plan.md)
- Assessment: [assessment-rubric-07.md](./assessment-rubric-07.md)
